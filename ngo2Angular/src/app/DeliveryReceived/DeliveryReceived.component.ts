...
@Component({
  selector: 'app-deliveryreceived',
  templateUrl: './DeliveryReceived.component.html',
  styleUrls: ['./DeliveryReceived.component.css'],
  providers: [DeliveryReceivedService]
})
export class DeliveryReceivedComponent implements OnInit {
  ...
  constructor(private serviceDeliveryReceived: DeliveryReceivedService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceDeliveryReceived.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'com.ngo2.DeliveryReceived',
    ...
    return this.serviceDeliveryReceived.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceDeliveryReceived.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceDeliveryReceived.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceDeliveryReceived.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
